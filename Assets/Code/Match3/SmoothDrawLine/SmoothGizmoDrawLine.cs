...
//https://forum.unity.com/threads/curve-movement-between-two-waypoints.351503/

namespace Assets.Code.Match3.Movement
{
    public class SmoothGizmoDrawLine : MonoBehaviour
    {
        [SerializeField]
